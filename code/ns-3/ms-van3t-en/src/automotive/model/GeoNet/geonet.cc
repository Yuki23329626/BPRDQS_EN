...
namespace ns3 {
  ...
  GeoNet::sendSHB (GNDataRequest_t dataRequest,GNCommonHeader commonHeader, GNBasicHeader basicHeader,GNlpv_t longPV)
  {
    ...
    if(m_PRRSupervisor_ptr!=nullptr)
    {
      ...
      m_PRRSupervisor_ptr->signalSentPacket (PRRSupervisor::bufToString (buffer,dataRequest.data->GetSize ()),m_egoPV.POS_EPV.lat,m_egoPV.POS_EPV.lon, dataRequest.data->GetSize ());
