...
func main() {
	...
	// 基本參數
	// sk 為 private key
	// fsk 為 user 與 blockchain 共用的 shared key
	...
	// 生成 random parameters ri1, ri2, ri3, rj1, rj2, rj3
	...
	// 生成 key word KW 與 temporary session key TK (用來加密影片的 symmetric key)
	...
	// 演算法過程中會使用到的變數計算如下，基本上都是定義在橢圓曲線上的運算
	...
	// 下面註解的 code 是用 BigInt 的格式輸出 decrypt_message
